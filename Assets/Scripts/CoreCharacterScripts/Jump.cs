...
public class Jump : Character
{
    ...
    private void IsJumping()
    {
        ...
        if(character.isJumping)
        {
            ...
            if (!character.isGrounded && numberOfJumpsLeft == 1) animMamager.SetAnimation(AnimateManager.TypeAnim.JUMP);
    ...
    private void AdditionalAir()
    {
        ...
        if (jumpHeld)
        {
            ...
            else
            {
                ...
                if (!character.isGrounded && numberOfJumpsLeft==0) animMamager.SetAnimation(AnimateManager.TypeAnim.DOUBLE_JUMP);
            }
        }
    ...
    private void Falling()
    {
        ...
        if (!character.isGrounded && rb.velocity.y<0) animMamager.SetAnimation(AnimateManager.TypeAnim.JUMP);
    }
